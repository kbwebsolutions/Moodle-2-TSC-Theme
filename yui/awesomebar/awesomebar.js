YUI.add('moodle-theme_moodle2_tsc-awesomebar', function(Y) {
...
AwesomeBar.prototype = {
    ...
    initializer : function(config) {
        Y.all('.moodle2_tsc-awesome-bar ul.dropdown li > span').each(this.enhanceAwesomeBar, this);
        Y.all('.moodle2_tsc-awesome-bar ul.dropdown li.clickable-with-children > a').each(this.enhanceAwesomeBar, this);
    },
...
Y.extend(AwesomeBar, Y.Base, AwesomeBar.prototype, {
    NAME : 'moodle2_tsc theme AwesomeBar enhancer',
    ATTRS : {
...
M.theme_moodle2_tsc.initAwesomeBar = function(cfg) {
